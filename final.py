import cv2,time
car_cascade = cv2.CascadeClassifier("car_cascade.txt")
bike_cascade = cv2.CascadeClassifier("bike_cascade.txt")
truck_cascade = cv2.CascadeClassifier("bus_cascade.txt")
carCount = 0
bikeCount = 0
truckCount = 0
